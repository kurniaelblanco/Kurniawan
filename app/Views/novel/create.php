...
<div class="p-3 mb-2 text-black" style="background-color: #ADD8E6;">
    <div class="container">
        <div class="row">
            <div class="col-8">
                <h2 class="my-2"> Tambahkan Data Novel</h2>
                ...
                <form action="/novel/save" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= ($validation->hasError('karya')) ? 'is-invalid' : ''; ?>" id="karya" name="karya" value="<?= old('karya'); ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= ($validation->hasError('jumlah_halaman')) ? 'is-invalid' : ''; ?>" id="jumlah_halaman" name="jumlah_halaman" value="<?= old('jumlah_halaman'); ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= ($validation->hasError('thn_terbit')) ? 'is-invalid' : ''; ?>" id="thn_terbit" name="thn_terbit" value="<?= old('thn_terbit'); ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= ($validation->hasError('isbn')) ? 'is-invalid' : ''; ?>" id="isbn" name="isbn" value="<?= old('isbn'); ?>">
                            <div class="invalid-feedback">
